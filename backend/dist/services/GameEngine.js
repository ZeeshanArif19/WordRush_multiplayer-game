...
exports.isWinningGuess = isWinningGuess;
exports.isGameOver = isGameOver;
exports.isValidGuessFormat = isValidGuessFormat;
/**
...
function evaluateGuess(guess, targetWord) {
    ...
    const result = Array(guessUpper.length).fill(null).map((_, i) => ({
        letter: guessUpper[i],
 ...
 */
function isWinningGuess(feedback) {
 ...
 */
function isGameOver(attempts, maxAttempts) {
 ...
 */
function isValidGuessFormat(guess, expectedLength) {
